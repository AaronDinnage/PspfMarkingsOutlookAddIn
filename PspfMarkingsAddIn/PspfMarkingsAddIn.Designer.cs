...
namespace PspfMarkings {
    ...
    public sealed partial class PspfMarkingsAddIn : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        protected override void Initialize() {
            ...
            Globals.PspfMarkingsAddIn = this;
    ...
    internal sealed partial class Globals {
        ...
        private static PspfMarkingsAddIn _PspfMarkingsAddIn;
        ...
        internal static PspfMarkingsAddIn PspfMarkingsAddIn {
            get {
                return _PspfMarkingsAddIn;
            }
            set {
                if ((_PspfMarkingsAddIn == null)) {
                    _PspfMarkingsAddIn = value;
                }
                else {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.PspfMarkingsAddIn.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.PspfMarkingsAddIn.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.PspfMarkingsAddIn.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
